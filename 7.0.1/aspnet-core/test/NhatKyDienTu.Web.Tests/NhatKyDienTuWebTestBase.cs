...
{
    public abstract class NhatKyDienTuWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NhatKyDienTuWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NhatKyDienTuWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NhatKyDienTuDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NhatKyDienTuDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NhatKyDienTuDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NhatKyDienTuDbContext, Task<T>> func)
        {
            T result;
