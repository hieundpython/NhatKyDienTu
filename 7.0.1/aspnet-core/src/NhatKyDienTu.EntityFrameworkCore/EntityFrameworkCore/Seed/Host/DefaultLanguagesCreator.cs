...
namespace NhatKyDienTu.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = NhatKyDienTuConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NhatKyDienTuDbContext context)
        {
            _context = context;
        }
